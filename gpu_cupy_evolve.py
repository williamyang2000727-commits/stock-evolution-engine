...
CHAT_IDS = [c for c in os.environ.get("TELEGRAM_CHAT_IDS", "").split(",") if c.strip()]
...
def main():
    ...
    print(f"")
    print(f"  ═══ Scoring（89.90 發現時的原版公式）═══")
    print(f"  主軸 s_wr × 2.0 (cap 80)  勝率 65%=+30 / 70%=+40 / 75%=+50 / 80%=+60")
    print(f"  波段 s_avg × 2.0 (cap 30)  avg 20%=+10 / 25%=+20 / 30%=+30")
    ...
    # d_mfi/d_cmf/d_atr_ratio removed from kernel (restore speed)
