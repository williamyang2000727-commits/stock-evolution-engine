...
PARAMS_SPACE = {
    # ====== 評分制買入（權重 0-3 + 門檻）======
    "w_rsi": [0,1,2,3], "rsi_th": [50,55,60,63,65,68,70,72,75,80],
    "w_bb": [0,1,2,3], "bb_th": [0.6,0.65,0.7,0.75,0.8,0.85,0.9,0.95,1.0],
    "w_vol": [0,1,2,3], "vol_th": [1.5,2.0,2.5,3.0,3.5,4.0,5.0,6.0],
    "w_ma": [0,1,2,3],
    "w_macd": [0,1,2,3], "macd_mode": [0,1,2],
    "w_kd": [0,1,2,3], "kd_th": [50,55,60,65,70,75,80,85], "kd_cross": [0,1],
    "w_wr": [0,1,2,3], "wr_th": [-15,-20,-25,-30,-35,-40,-50],
    "w_mom": [0,1,2,3], "mom_th": [3,5,8,10,12],
